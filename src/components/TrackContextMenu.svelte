...
<style>
  ...
  .menu button { display: block; width: 100%; padding: 9px 12px; border: 0; border-radius: 8px; color: #eee; background: none; text-align: left; font: inherit; font-size: .85rem; cursor: pointer; }
  .menu button:hover { background: #ffffff14; }
  .menu button.danger { color: #fca5a5; }
  .menu button.danger:hover { background: #fca5a51f; }
</style>