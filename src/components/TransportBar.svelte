...
<style>
  ...
  .transport-actions { display:flex; align-items:center; justify-content:flex-end; gap:13px; width:270px; min-width:0; }.volume { display:flex; align-items:center; gap:6px; color:#a99b8f; }.volume svg { width:17px; height:17px; fill:none; stroke:currentColor; stroke-width:1.8; stroke-linecap:round; stroke-linejoin:round; }.volume input { width:70px; accent-color:#f2ece4; }.loading {color:#f2ece4;font-size:.68rem; white-space:nowrap; }
